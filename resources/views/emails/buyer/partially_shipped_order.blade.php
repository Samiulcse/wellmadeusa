...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>LUMIERE | PARTIALLY SHIPPED ORDERED -  #{{ $order->order_number }}</title>
</head>
<body>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="center"  style="font-size:0px;padding:0px;word-break:break-word">
                                                                <div style="font-weight:bold;font-family:Arial;color:rgb(0,0,0);font-size:20px;line-height:20px;margin-top:50px">Your order is on its way</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"  style="font-size:0px;padding:23px 0px 0px;word-break:break-word">
                                                                <div style="text-transform:uppercase;font-family:Arial;font-size:14px;line-height:20px;color:rgb(0,0,0)">ORDER TRACKING NO. @if(!empty($order->tracking_number)) {{ $order->tracking_number }} @else --------- @endif</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center"  style="font-size:0px;padding:23px 0px 62px;word-break:break-word">
                                                                <div style="text-transform:uppercase;font-family:Arial;font-size:14px;line-height:20px;color:rgb(0,0,0)">SHIPPING CHARGE @if(!empty($order->shipping_cost)) {{ $order->shipping_cost }} @else --------- @endif</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  style="font-size:0px;padding:0px;word-break:break-word">
                                                                <div style="font-family:Arial;font-size:14px;line-height:20px;color:rgb(0,0,0)">
                                                                    <p style="margin:0px 0px 18px;text-transform:uppercase; text-align:center;">YOU CAN TRACK YOUR SHIPMENT 
                                                                        @if(!empty($order->tracking_number)) 
                                                                        <a href="http://wwwapps.ups.com/WebTracking/track?track=yes&trackNums={{ $order->tracking_number }}">VIA THIS LINK</a>
                                                                        @else
                                                                        <a href="#!">VIA THIS LINK</a>
                                                                        @endif
                                                                    </p>
                                                                </div>
                                                            </td>
            ...
            <tr>
                <td>
                   <?php
                    ...
                    ?>
                    @if ($thumb)
                        <img height="auto" src="{{ asset($thumb) }}" width="240" style="outline:none;object-fit:contain;border:0px;display:block;height:auto;width:240px; margin-left: auto; margin-right: auto;" tabindex="0">
                    @else
                    ...
                    <div class="a6S" style="text-align: center; margin-top: 50px;">
                        ...
                        <div style="font-family:Arial;font-size:14px;line-height:20px;text-transform:uppercase">
                            <b style="background-color:rgb(255,255,255)">
                                <font color="#ff0000">(PARTIALLY SHIPPED ORDERED)</font>
                            </b>
                        </div>
