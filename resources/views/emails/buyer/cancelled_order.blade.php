...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>LUMIERE | CANCELLED ORDER -  #{{ $order->order_number }}</title>
</head>
<body>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="center"  style="font-size:0px;padding:0px;word-break:break-word">
                                                                <div style="font-weight:bold;font-family:Arial;color:rgb(0,0,0);font-size:20px;line-height:20px;margin-top:50px">Your Order is Cancelled</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                    ...
                    <div class="a6S" style="text-align: center; margin-top: 50px;">
                        ...
                        <div style="font-family:Arial;font-size:14px;line-height:20px;text-transform:uppercase">
                            <b style="background-color:rgb(255,255,255)">
                                <font color="#ff0000">(CANCELLED ORDERED)</font>
                            </b>
                        </div>
