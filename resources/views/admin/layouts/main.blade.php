...
<head>
    ...
    <title>{{ config('app.name', 'Shopbasic USA') }}</title>
                ...
                <div class="ly-row">
                    <div class="ly-12">
                        <div class="footer_copyright text_center">
                            <p>© Copyright <?php echo date('Y'); ?> by wellmade.com. All rights reserved. <a href="#">Terms of Use</a> <a href="#">Brand Guideline</a> </p>
                            @if(isset($logo_path))
                                @if ($logo_path != '')
        ...
        <div class="modal_inner">
            <div class="modal_wrapper modal_500p">
                <div class="modal_header display_table white_bg no_border pa15 pb_0">
                    <span class="modal_header_title font_16p">This is where your Order Notice will appear on Shopbasic USA:</span>
