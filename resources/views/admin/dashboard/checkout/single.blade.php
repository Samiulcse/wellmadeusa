...
<div class="item_size_content">
    <div class="table-responsive ">
        <form action="{{ route('admin_checkout_post') }}" method="POST" class="cartListForm" id="checkoutForm">
            @csrf
            <div class="ly-wrap">
                <div class="ly-row">
                    <div class="ly-7">
                        ...
                        <div class="ly-row">
                            <div class="ly-12">
                                ...
                                @if ($errors->has('shipping_method'))
                                    <div class="form-control-feedback">Select a shipping method</div>
                                @endif
                        ...
                        <div class="ly-row table_bordered mt_15">
                            <div class="ly-12">
                                ...
                                @if ($errors->has('paymentMethod'))
                                    <div class="form-control-feedback">Select a Payment Method</div>
                                @endif
                                @if ($errors->has('number'))
                                    <div class="form-control-feedback">Invalid Card Number</div>
                                @endif
                                @if ($errors->has('cvc'))
                                    <div class="form-control-feedback">Invalid Card CVC</div>
                                @endif
                                @if ($errors->has('expiry'))
                                    <div class="form-control-feedback">Invalid Card expiry</div>
                                @endif
                                ...
                                <h4 class="font_14p mb_15 mt_15 item_change_title">
                                    ...
                                    <img class="float_right" src="{{ asset('themes/front/images/card.jpg') }}"/>
                                </h4>
                            </div>
                            <div class="ly-6">
                                <div class="form_row ">
                        ...
                        <div class="ly-row m10">
                            ...
                            <div class="form_row">
                                <div class="form_inline">
                                    <div class="custom_radio">
                                        <input id="btnSubmit" type="submit" class="ly_btn btn_blue width_200p mt_15 p10  signin_btn place-my-order-btn" value="PLACE MY ORDER" onclick="$(this).attr('disabled', true); $('#checkoutForm').submit()">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="modalForm">
                        ...
                        <div class="ly-row">
                            <div class="ly-4">
                                <div class="form_row">
                                    <div class="form_inline">
                                        <div class="label_inline mb_5">Store No.</div>
                                        <input class="form_global" type="text" id="store_no" name="store_no">
                                    </div>
                                </div>
                            </div>
                            <div class="ly-6">
                            ...
                            <div class="ly-6">
                                <div class="form_row ">
                                    ...
                                    <div class="form_inline" id="form-group-state-select">
                                        ...
                                        <!-- <input type="text" name="" class="form_global d_none"> -->
                                        <div class="select">
                        ...
                        <div class="ly-row">
                            <div class="ly-12">
                                <div class="form_row">
                                    <div class="form_inline">
                                        <div class="custom_checkbox">
                                            <input type="checkbox" id="showroomCommercial" name="checkbox">
                                            <label class="pl_15 pr_5" for="showroomCommercial" name="showroomCommercial" value="1">This address is commercial.</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
