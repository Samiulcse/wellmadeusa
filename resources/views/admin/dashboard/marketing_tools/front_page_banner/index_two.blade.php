...
@section('content')
    ...
    <div class="row {{ ($errors && sizeof($errors) > 0) ? '' : 'd-none' }}" id="addEditRow">
        <div class="col-md-12" style="border: 1px solid black">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" id="form" method="post" action="{{ route('admin_front_page_banner_two_add') }}">
                @csrf
                ...
                <div class="form-group row{{ $errors->has('head') ? ' has-danger' : '' }}">
                    <div class="col-lg-2">
                        <label for="head" class="col-form-label">Heading </label>
                    </div> 
                    <div class="col-lg-5">
                ...
                <!--<div class="form-group row{{ $errors->has('details') ? ' has-danger' : '' }}">-->
                <!--    <div class="col-lg-2">-->
                <!--        <label for="details" class="col-form-label">Description</label>-->
                <!--    </div> -->
                <!--    <div class="col-lg-5">-->
                <!--        <input class="form-control{{ $errors->has('details') ? ' is-invalid' : '' }}"-->
                <!--               type="text" id="details" name="details" value="{{ old('details') }}">-->
                <!--    </div>-->
                <!--</div>-->

                <div class="form-group row{{ $errors->has('link') ? ' has-danger' : '' }}">
                    <div class="col-lg-2">
                        <label for="link" class="col-form-label">Show on device *</label>
                    </div>

                    <div class="col-lg-5">
                        <label class="radio-inline ">
                          <input type="radio" name="type"   id="lgdevice" value="11" required=""> For Large Device
                        </label>
                        <!--<label class="radio-inline">-->
                        <!--  <input type="radio" name="type"   id="smdevice" value="13" required=""> For Small Device-->
                        <!--</label> -->
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12"> <h3>Banner Item For Large Device</h3> </div>
        <div class="col-md-12">
                ...
                <ul id="HomePageSliderItems"> 
                    @foreach($images as $image)
                        <li class="text-center" data-id="{{ $image->id }}">
                            ...
                            <a class="text-info btnEdit" data-head="{{ $image->head }}" data-details="{{ $image->details }}" data-id="{{ $image->id }}">Edit</a>
                        </li>
                    @endforeach
                </ul>
            </div>
...
<br>
    ...
    <!--<div class="row">-->
    <!--    <div class="col-md-12"> <h3>Banner Item For Small Device</h3> </div>-->
    <!--    <div class="col-md-12">-->
    <!--        <div class="banner-item-container">-->
    <!--            <ul id="HomePageSliderItems">-->
            ...
            $('#modalBtnEdit').click(function () {
                ...
                if (url!='' ) {
                    $.ajax({
                        ...
                        data: { id: selectedId, url: url, head: head, details: details }
                    }).done(function( msg ) {
                        location.reload();
                    });
                } else {
                    $('#htmlMsg').html('<p class="text-danger">URL  is required!</p>')
                }
            });
        })
    </script>
