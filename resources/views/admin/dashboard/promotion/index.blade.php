...
<div class="ly_accrodion">
    <div class="ly_accrodion_heading">
        <div id="btnAddNew" class="ly_accrodion_title {{ count($errors) > 0 ? ' open_acc' : ''}}" data-toggle="accordion" data-target="#addPromotion" data-class="accordion">
            <span id="addEditTitle">{{ old('inputAdd') == '0' ? 'Edit Promotions' : 'Add Promotions' }}</span>
        </div>
    </div>
        ...
        <form class="form-horizontal" enctype="multipart/form-data" id="form"
            ...
            <div class="form_row">
                ...
                <div class="form_inline">
                    <div class="custom_radio">
                        <input type="radio" class="form_global" id="statusActive" name="status" value="1" checked="">
                        <label for="statusActive">Active</label>
                    </div>
                    <div class="custom_radio">
                        <input type="radio" class="form_global"  id="statusInactive" name="status" value="0">
            ...
            <div class="form_row">
                ...
                <div class="form_inline">
                    ...
                    <div class="custom_radio">
                        <input id="permanentYes" name="is_permanent" type="radio" class="form_global" value="1" {{ (old('is_permanent') == '1' || empty(old('is_permanent'))) ? 'checked' : '' }}>
                        <label for="permanentYes" class=""> Permanent </label>
                    </div>
                    
                    <div class="custom_radio">
                        <input id="permanentNo" name="is_permanent" type="radio" class="form_global" value="0" {{ old('is_permanent') == '0' ? 'checked' : '' }}>
                        <label for="permanentNo" class=""> From </label> 
                    </div>
                    <div class="form_inli" id="fromtodate" style="display: none;">
                    <span class="custom-control-indicator"></span>From&nbsp;&nbsp;<input type="text" id="valid_from" class="form-control{{ $errors->has('valid_from') ? ' is-invalid' : '' }}"
                                name="valid_from" value="{{ old('valid_from') }}">&nbsp;&nbsp;To&nbsp;&nbsp;
                                <span class="custom-control-indicator"></span><input type="text" id="valid_to" class="form-control{{ $errors->has('valid_to') ? ' is-invalid' : '' }}"
                                name="valid_to" value="{{ old('valid_to') }}">
                    </div>
                </div>
            </div> 
            <div class="form_row">
                <div class="label_inline required width_150p {{ $errors->has('hasCouponCode') ? ' has-danger' : '' }}">
    ...
    <script>
        $(function () {
            ...
            $('#btnAddNew').click(function () {
                ...
                $('#addEditTitle').html('Add Promotion');
                $('#btnSubmit').html('Add');
                $('#inputAdd').val('1');
                $('#form').attr('action', '{{ route('admin_promotions_add_post') }}');
            });
            $('#permanentNo').click(function(){
                if($('#permanentNo').prop('checked', true)){
                     $("#fromtodate").show();
                }
            });
            $('#permanentYes').click(function(){
                if($('#permanentYes').prop('checked', true)){
                     $("#fromtodate").hide();
                }
            });
            ...
            $('.btnEdit').click(function () {
                ...
                $('#addEditRow').removeClass('d-none');
                $('#addBtnRow').addClass('d-none');
                $('#addEditTitle').html('Edit Promotion');
                ...
                {
                    $('#multipleUseActive').prop('checked', true);
                } else {
                    $('#multipleUseInactive').prop('checked', true);
                }
