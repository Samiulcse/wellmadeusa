...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <span class="link mr_20 item_color_btn" id="btnAddNew">+ Add New Master Febric</span>
        </div>
    </div>
            ...
            <table class="table table-striped">
                ...
                @foreach($fabrics as $fabric)
                    <tr>
                        ...
                        <td>
                            <a class="link btnEdit" data-id="{{ $fabric->id }}" data-index="{{ $loop->index }}" role="button" style="color: blue">Edit</a> |
                            <a class="link btnDelete" data-id="{{ $fabric->id }}" role="button" style="color: red">Delete</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <div class="modal_wrapper modal_470p">
                <div class="item_list_popup">
                    <div class="modal_header display_table">
                        <span class="modal_header_title">Add Master Fabric</span>
                            ...
                            <form class="form-horizontal" id="form" method="POST">
                                ...
                                <div class="form_row">
                                    ...
                                    <div class="form_inline">
                                        <input type="text" id="modalName" class="form_global" placeholder="Fabric Name" name="name">
                                    </div>
                                </div>
