<form class="form-horizontal" action="{{ route('admin_company_information_post') }}" method="POST">
    ...
    <div class="form_row">
        ...
        <div class="form_inline">
            <textarea class="form_global{{ $errors->has('company_description') ? ' is-invalid' : '' }}"
                rows="5" name="company_description">@if(!empty($user->vendor->company_info)) {{ empty(old('company_description')) ? ($errors->has('company_description') ? '' : $user->vendor->company_info) : old('company_description') }} @endif</textarea>
        </div>
    </div>
        ...
        <div class="ly-row">
            <div class="ly-6 pl_0 pr_60">
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_address') ? ' is-invalid' : '' }}" name="showroom_address"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_city') ? ' is-invalid' : '' }}" name="showroom_city"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_zip_code') ? ' is-invalid' : '' }}" name="showroom_zip_code"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_tel') ? ' is-invalid' : '' }}" name="showroom_tel"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_alt') ? ' is-invalid' : '' }}" name="showroom_alt"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('showroom_fax') ? ' is-invalid' : '' }}" name="showroom_fax"
            ...
            <div class="ly-6 pl_0 pr_60">
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_address') ? ' is-invalid' : '' }}" name="warehouse_address"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_city') ? ' is-invalid' : '' }}" name="warehouse_city"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_zip_code') ? ' is-invalid' : '' }}" name="warehouse_zip_code"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_tel') ? ' is-invalid' : '' }}" name="warehouse_tel"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_alt') ? ' is-invalid' : '' }}" name="warehouse_alt"
                ...
                <div class="form_row">
                    ...
                    <div class="form_inline">
                        <input type="text" class="form_global{{ $errors->has('warehouse_fax') ? ' is-invalid' : '' }}" name="warehouse_fax"
    ...
    <div class="text_right m15">
        <div class="display_inline mr_0">
            <button class="ly_btn  btn_blue min_width_100p ">Save</button>
        </div>
    </div>
</form>