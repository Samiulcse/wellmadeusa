<form class="form-horizontal" method="POST" id="form-settings">
    ...
    <div class="form_row">
        <div class="label_inline fw_500 required width_150p">
            <label for="setting_description">Minimum Order: </label>            
        </div>
        <div class="form_inline">
            <input id="setting_description" type="text" class="form_global" name="min_order" value="{{ $vendor->min_order }}" id="min_order" placeholder="$">
        </div>
    </div>
