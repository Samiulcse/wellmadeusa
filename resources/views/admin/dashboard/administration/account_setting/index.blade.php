...
@section('additionalCSS')
    ...
    <style>
        ...
        /*Code: 19-03-25 For show Radio button*/
        .custom-control {
        }
...
<div class="vendor_info_content">
    <div class="tab_wrapper pa_0">
        <div class="ly_tab">
            <nav class="tabs">
                <ul class="tab_four">
                    <li href="#AdminPassword" class=" {{ request()->get('c') != 'login' ? 'active' : '' }}">Admin ID & Password</li>
                    <li href="#ManageAccounts">Manage Accounts</li>
                    <li href="#LoginHistory" class=" {{ request()->get('c') == 'login' ? 'active' : '' }}">Login History</li>
                </ul>   
            </nav>
            <div class="tab_content_wrapper">
                <div id="AdminPassword" class="tab_content {{ request()->get('c') != 'login' ? 'show active' : '' }}">
                    <div class="fadein">
                ...
                <div id="LoginHistory" class="tab_content {{ request()->get('c') == 'login' ? 'show active' : '' }}">
                    <div class="fadein">
