...
<div class="ly_accrodion">
    ...
    <div class="accordion_body default_accrodion open" id="addAccount" style="">
        ...
        <div class="form_row">
            ...
            <div class="form_inline">
                <input type="text" class="form_global" value="{{ old('user_name') }}" name="user_name"  id="userName">
            </div>
        ...
        <div class="form_row">
            ...
            <div class="form_inline">
                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="items" value="{{ Permissions::$ITEMS }}">
                    <label for="items">Items</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="ordersId" value="{{ Permissions::$ORDERS }}">
                    <label for="ordersId">Orders</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="customersId" value="{{ Permissions::$CUSTOMERS }}">
                    <label for="customersId">Customers</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="marketingTools" value="{{ Permissions::$MARKETING_TOOLS }}">
                    <label for="marketingTools">Marketing Tools</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="feedback" value="{{ Permissions::$FEEDBACK }}">
                    <label for="feedback">Feedback</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="statisticsId" value="{{ Permissions::$STATISTICS }}">
                    <label for="statisticsId">Statistics</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="messages" value="{{ Permissions::$MESSAGES }}">
                    <label for="messages">Messages</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="admin" value="{{ Permissions::$ADMIN }}">
                    <label for="admin">Admin</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="payment" value="{{ Permissions::$PAYMENT }}">
        ...
        <div class="form_row">
            ...
            <div class="form_inline">
                <div class="custom_checkbox mr_20">
                    <input type="checkbox" class="permission" id="refundAccess" value="{{ Permissions::$REFUND }}">
                    <label for="refundAccess">Refund Access</label>
                </div>
            </div>
        </div>
            ...
            <tbody id="accountsBody">
                ...
                @foreach($users as $item)
                    <tr>
                        ...
                        <td><span class="userName">{{ $item->user_name }}</span></td>
