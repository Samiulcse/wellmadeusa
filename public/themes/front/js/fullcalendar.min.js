...
(function(t) {
    ...
    function b(t, e) {
        var n, i, r;
        for (n = 0; ze.length > n && (i = ze[n], r = D(i, t, e), !(r >= 1 && V(r))); n++);
        return i
    }
    ...
    function A(n, i, r) {
        ...
        return e.isMoment(u) ? (a = e.apply(null, n), Y(u, a)) : C(u) || void 0 === u ? a = e.apply(null, n) : (s = !1, o = !1, d ? Le.test(u) ? (u += "-01", n = [u], s = !0, o = !0) : (l = Pe.exec(u)) && (s = !l[5], o = !0) : t.isArray(u) && (o = !0), a = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (a._ambigTime = !0, a._ambigZone = !0) : r && (o ? a._ambigZone = !0 : d && a.zone(u))), a._fullCalendar = !0, a
    }
    ...
    function me(n, r) {
        ...
        function a() {
            re = Q.theme ? "ui" : "fc", n.addClass("fc"), Q.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), Q.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"), ie = t("<div class='fc-view-container'/>").prependTo(n), ee = new ve(q, Q), ne = ee.render(), ne && n.prepend(ne), c(Q.defaultView), Q.handleWindowResize && (le = G(w, Q.windowResizeDelay), t(window).resize(le))
        }

        function u() {
            se && se.destroyView(), ee.destroy(), ie.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), t(window).unbind("resize", le)
        }
        ...
        function f(n) {
            ...
            var r, s, l, a, u, d = Q.defaultButtonText || {},
                c = Q.buttonText || {},
                h = Q.views || {},
                f = n,
                g = [],
            ...
            return g.unshift({}), r = t.extend.apply(t, g), s ? (l = r.duration || s.duration, l && (l = e.duration(l), a = b(l), p = 1 === l.as(a)), p && h[a] && (r = t.extend({}, h[a], r)), u = c[n] || (p ? c[a] : null) || d[n] || (p ? d[a] : null) || r.buttonText || s.buttonText || (l ? o(l) : null) || n, he[n] = {
                "class": s,
                options: r,
                buttonText: u
            }) : void 0
        ...
        function m(t) {
            return d() ? (t && y(), fe++, se.updateSize(!0), fe--, !0) : void 0
        }
        ...
        function y() {
            oe = "number" == typeof Q.contentHeight ? Q.contentHeight : "number" == typeof Q.height ? Q.height - (ne ? ne.outerHeight(!0) : 0) : Math.round(ie.width() / Math.max(Q.aspectRatio, .5))
        }

        function w(t) {
            !fe && t.target === window && se.start && m(!0) && se.trigger("windowResize", ce)
        }
        ...
        function S() {
            d() && (I(), se.destroyViewEvents(), se.renderViewEvents(ge), W())
        }

        function D() {
            I(), se.destroyViewEvents(), W()
        }

        function C() {
            !Q.lazyFetching || ue(se.start, se.end) ? T() : S()
        }
        ...
        function k() {
            ee.updateTitle(se.title)
        }

        function M() {
            var t = q.getNow();
            t.isWithin(se.intervalStart, se.intervalEnd) ? ee.disableButton("today") : ee.enableButton("today")
        }

        function F(t, e) {
            t = q.moment(t), e = e ? q.moment(e) : t.hasTime() ? t.clone().add(q.defaultTimedEventDuration) : t.clone().add(q.defaultAllDayEventDuration), se.select({
                start: t,
                end: e
            })
        }
        ...
        function _() {
            ae = se.computePrevDate(ae), c()
        }

        function P() {
            ae = se.computeNextDate(ae), c()
        }
        ...
        function O(t) {
            ae.add(e.duration(t)), c()
        }

        function B(t, e) {
            var n, i;
            e && g(e) || (e = e || "day", n = ee.getViewsWithButtons().join(" "), i = n.match(RegExp("\\w+" + L(e))), i || (i = n.match(/\w+Day/)), e = i ? i[0] : "agendaDay"), ae = t, c(e)
        }
        ...
        function $(t, e) {
            return void 0 === e ? Q[t] : (("height" == t || "contentHeight" == t || "aspectRatio" == t) && (Q[t] = e, m(!0)), void 0)
        }

        function U(t, e) {
            return Q[t] ? Q[t].apply(e || ce, Array.prototype.slice.call(arguments, 2)) : void 0
        }
        var q = this;
        r = r || {};
        var K, Q = i({}, Ee, r);
        K = Q.lang in Te ? Te[Q.lang] : Te[Ee.lang], K && (Q = i({}, Ee, K, r)), Q.isRTL && (Q = i({}, Ee, be, K || {}, r)), q.options = Q, q.render = l, q.destroy = u, q.refetchEvents = E, q.reportEvents = H, q.reportEventChange = R, q.rerenderEvents = S, q.changeView = c, q.select = F, q.unselect = z, q.prev = _, q.next = P, q.prevYear = V, q.nextYear = A, q.today = N, q.gotoDate = Y, q.incrementDate = O, q.zoomTo = B, q.getDate = Z, q.getCalendar = j, q.getView = X, q.option = $, q.trigger = U, q.isValidViewType = g, q.getViewButtonText = p;
        var J = x(s(Q.lang));
        ...
        q.defaultAllDayEventDuration = e.duration(Q.defaultAllDayEventDuration), q.defaultTimedEventDuration = e.duration(Q.defaultTimedEventDuration), q.moment = function() {
            var t;
            return "local" === Q.timezone ? (t = De.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === Q.timezone ? De.moment.utc.apply(null, arguments) : De.moment.parseZone.apply(null, arguments), "_locale" in t ? t._locale = J : t._lang = J, t
        ...
        var ee, ne, ie, re, se, oe, le, ae, ue = q.isFetchNeeded,
            de = q.fetchEvents,
            ce = n[0],
            he = {},
            fe = 0,
            ge = [];
        ae = null != Q.defaultDate ? q.moment(Q.defaultDate) : q.getNow(), q.getSuggestedViewHeight = function() {
            return void 0 === oe && v(), oe
    ...
    function ye(n) {
        ...
        function V(e, n) {
            var i, r;
            return n && (i = t.extend({}, n, e), r = H(b(i))[0]), r ? L(e, r) : (e = x(e), P(e))
        }
        ...
        function A(t) {
            return "businessHours" === t ? _() : "object" == typeof t ? H(b(t)) : v(t)
        }
        ...
        t.each((n.events ? [n.events] : []).concat(n.eventSources || []), function(t, e) {
            var n = a(e);
            n && $.push(n)
        }), O.getBusinessHoursEvents = _, O.isEventRangeAllowed = L, O.isSelectionRangeAllowed = P, O.isExternalDropRangeAllowed = V
    }
    ...
    var Re, ke, Me, Fe = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        ...
        _e = {}.hasOwnProperty,
        Le = /^\s*\d{4}-\d\d$/,
        Pe = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        Ve = e.fn,
        Ge = t.extend({}, Ve);
    De.moment = function() {
        return A(arguments)
    ...
    }, Ve.stripTime = function() {
        var t;
        return this._ambigTime || (t = this.toArray(), this.utc(), ke(this, t.slice(0, 3)), this._ambigTime = !0, this._ambigZone = !0), this
    }, Ve.hasTime = function() {
        return !this._ambigTime
    }, Ve.stripZone = function() {
        var t, e;
        return this._ambigZone || (t = this.toArray(), e = this._ambigTime, this.utc(), ke(this, t), this._ambigTime = e || !1, this._ambigZone = !0), this
    }, Ve.hasZone = function() {
        return !this._ambigZone
    }, Ve.local = function() {
        var t = this.toArray(),
            e = this._ambigZone;
        return Ge.local.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, e && Me(this, t), this
    }, Ve.utc = function() {
        return Ge.utc.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, this
    }, t.each(["zone", "utcOffset"], function(t, e) {
        Ge[e] && (Ve[e] = function(t) {
    ...
    }, Ve.isWithin = function(t, e) {
        var n = N([this, t, e]);
        return n[0] >= n[1] && n[0] < n[2]
    }, Ve.isSame = function(t, e) {
        var n;
    ...
    $e.mixin({
        ...
        fgSegHtml: function(t, e) {
            var n, i = this.view,
                ...
                u = "";
            return l.unshift("fc-day-grid-event"), !r.allDay && t.isStart && (u = '<span class="fc-time">' + z(this.getEventTimeText(r)) + "</span>"), n = '<span class="fc-title">' + (z(r.title || "") || "&nbsp;") + "</span>", '<a class="' + l.join(" ") + '"' + (r.url ? ' href="' + z(r.url) + '"' : "") + (a ? ' style="' + a + '"' : "") + ">" + '<div class="fc-content">' + (this.isRTL ? n + " " + u : u + " " + n) + "</div>" + (o ? '<div class="fc-resizer"/>' : "") +(r.desc ? '<div class="cal-desc"><p>'+ r.desc : "")+ "</p></div></a>"
        },
    ...
    var qe = De.View = K.extend({
        ...
        computeRange: function(t) {
            var n, i, r = e.duration(this.opt("duration") || this.constructor.duration || {
                ...
                o = t.clone().startOf(s),
                l = o.clone().add(r);
            return /year|month|week|day/.test(s) ? (o.stripTime(), l.stripTime()) : (o.hasTime() || (o = this.calendar.rezoneDate(o)), l.hasTime() || (l = this.calendar.rezoneDate(l))), n = o.clone(), n = this.skipHiddenDays(n), i = l.clone(), i = this.skipHiddenDays(i, -1, !0), {
                intervalDuration: r,
                intervalUnit: s,
                intervalStart: o,
                intervalEnd: l,
