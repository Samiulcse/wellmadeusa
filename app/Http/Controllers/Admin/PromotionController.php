...
class PromotionController extends Controller
{
    public function index() {
        ...
        return view('admin.dashboard.promotion.index', compact( 'promotions'))->with('page_title', 'Promotions');
    }
    ...
    public function addPost(Request $request) {
        ...
        $inputPromotion = array(
            ...
            'coupon_code' => ($request->hasCouponCode == 1) ? strtoupper($request->coupon_code) : '',
        ...
        return redirect()->route('admin_promotions')->with('message', 'Promotion Has Been Added!');
    ...
    public function editPost(Request $request) {
        ...
        $promotion->coupon_code = ($request->hasCouponCode == 1) ? strtoupper($request->coupon_code) : '';
        ...
        return redirect()->route('admin_promotions')->with('message', 'Promotion Has Been Updated!');
