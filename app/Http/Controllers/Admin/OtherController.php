...
class OtherController extends Controller
{
    ...
    public function welcomeNotification() {
        ...
        return view('admin.dashboard.welcome_notification.index', compact('setting'))->with('page_title', 'Welcome Notification');
    }
    ...
    public function topNotification() {
        ...
        return view('admin.dashboard.top_notification.index', compact('setting'))->with('page_title', 'Top Notification');
    }
